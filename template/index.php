					...
					<div class="row">
						<div class="col-md-offset-1 col-md-10">
							<form class="form-horizontal" role="form">
								...
								<div class="form-group">
									<div class="col-md-offset-2 col-md-8">
										<input type="email" class="form-control" id="inputEmail" placeholder="Facebook">
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-offset-2 col-md-8">
										<input type="text" class="form-control" id="inputSubject" placeholder="WhatsApp">
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-offset-2 col-md-8">
										<input type="text" class="form-control" rows="3" placeholder="E-mail"></textarea>
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-offset-2 col-md-8">
										<button type="button" class="btn btn-theme btn-lg btn-block">Cadastrar</button>
									</div>
								</div>
							</form>
						</div>
					...
					<div class="row">
						<div class="col-md-offset-1 col-md-10">
							<form class="form-horizontal" role="form" action="index.php" method="get" >
								<div class="form-group">
									<div class="col-md-offset-2 col-md-8">
										<input type="text" class="form-control" name="codigo" placeholder="DIGITAR: 74w2c">
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-offset-2 col-md-8">
										<button type="submit"  value="Submit" name="enviar" class="btn btn-theme btn-lg btn-block">Pesquisar</button>
									</div>
								</div>
							</form>
						</div>
                        ...
                        <?php
                            ...
                            if (array_key_exists("codigo", $_GET) && $_GET["codigo"] == "74w2c"){

                                    echo "<div class=\"row\"> <div class=\"col-md-offset-1 col-md-10\">";
                                    echo "<p>Dono PET: Gefferson Vivan</p>";
                                    echo "<p>Facebook: <a href=\"https://www.facebook.com/geffersonvivan\" target='_blank'>Gefferson Vivan</a></p>";
                                    echo "<p>WhatsApp: (49) 99133-8813</p>";
                                    echo "<p>E-mail: <a href=\"mailto:geffersonvivan@gmail.com\">geffersonvivan@gmail.com</a> </p>";
                                    echo "</div> </div>";
                            }
                        ?>
